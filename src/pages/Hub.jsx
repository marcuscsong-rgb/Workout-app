...
export default function Hub({ user }) {
  ...
  // Load messages when hub changes
  useEffect(() => {
    if (activeHub) {
  ...
  async function createHub() {
    ...
    // Invite other user if username provided
    ...
    <div className="flex flex-col h-screen pb-16">
      ...
      <div className="px-4 py-3 border-t border-gray-100 bg-white flex gap-2 items-center">
        ...
        <button
          ...
          className="w-9 h-9 bg-blue-600 rounded-full flex items-center justify-center disabled:opacity-40"
        >
